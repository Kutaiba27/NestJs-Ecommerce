...
export class BrandController {
   ...
   async addBrand(@UploadedFile() file: Express.Multer.File, @Body(new SlugPipePipe("name"), ValidationPipe,) brandInfo: CreateBrand) {
   ...
   @Put('update-brand')
   async updateBrand(@Body(new SlugPipePipe("name"), ValidationPipe,) brandInfo: UpdateBrand, @Query('id') id: number) {
